            ...
            <div class="bg-white p-4 rounded-[26px] flex flex-col gap-3">
              ...
              <div class="flex justify-between items-center">
                ...
                <p class="text-sm leading-[22px] tracking-035">
                  <span class="font-semibold text-[#4D73FF] text-nowrap">Rp {{number_format($tour->price, 0, ',', '.')}}</span><span class="text-darkGrey">{{$tour->days}}/night</span>
                </p>
              </div>
            </div>
          </a>
        @empty
        <p>belum ada paket villa pada kategori ini</p>
        @endforelse
        </div>
    </section>
    @endsection
