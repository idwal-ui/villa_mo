    ...
    <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-8">
      ...
      <div class="flex flex-1 flex-col h-full justify-center px-4 gap-8">
        <div class="px-[35px] w-full flex shrink-0">
          <img src="{{asset('assets/backgrounds/Bank-Account-Illustration.jpg')}}" class="object-contain" alt="background">
        </div>
          ...
          <div class="flex flex-col gap-3">
            ...
            <div class="bg-white p-[16px_24px] rounded-[26px]">
              <label for="bca" class="flex items-center justify-between">
                ...
                <input type="radio" value="{{$bank->id}}" name="package_bank_id" id="{{$bank->bank_id}}" class="w-5 h-5 appearance-none checked:border-[3px] checked:border-solid checked:border-white rounded-full checked:bg-[#6E5DE7] ring-2 ring-[#6E5DE7]">
              </label>
            </div>
            @endforeach
