        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.package_tours.index')" :active="request()->routeIs('admin.package_touurs.index')">
                        {{ __('Package Vila') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('customer')
                    ...
                    <x-responsive-nav-link :href="route('admin.package_tours.index')" :active="request()->routeIs('admin.package_touurs.index')">
                        {{ __('Package Vila') }}
                    </x-responsive-nav-link>
